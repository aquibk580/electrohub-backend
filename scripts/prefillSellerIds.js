...
function prefillSellerIds() {
    return __awaiter(this, void 0, void 0, function () {
        var orderItems, _i, orderItems_1, item, err_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    orderItems = _b.sent();
                    console.log("Found ".concat(orderItems.length, " orderItems to update..."));
                    _i = 0, orderItems_1 = orderItems;
                    _b.label = 2;
                case 2:
                    if (!(_i < orderItems_1.length)) return [3 /*break*/, 5];
                    item = orderItems_1[_i];
                    if (!((_a = item.product) === null || _a === void 0 ? void 0 : _a.sellerId)) return [3 /*break*/, 4];
                ...
                case 6:
                    err_1 = _b.sent();
                    console.error("❌ Error during backfill:", err_1);
                    return [3 /*break*/, 9];

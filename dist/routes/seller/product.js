...
router.post("/:sellerId", isLoggedIn, isSeller, upload.array("images", 5), checkFileCount, createProduct);
...
router.patch("/:productId", isLoggedIn, isSeller, upload.array("images", 5), checkFileCount, updateProduct);
